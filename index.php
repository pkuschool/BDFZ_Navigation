    ...
    <nav id="container" class="blue-grey darken-1">
        <div class="nav-wrapper blue-grey darken-1" >
            ...
            <ul class="right hide-on-med-and-down">
                ...
                <li><a href="https://github.com/pkuschool/BDFZ_Navigation/issues/new/choose"><i
                            class="material-icons">feedback</i></a></li>
                <li><a href="./about.html"><i class="material-icons">info</i></a></li>
            </ul>
        </div>
    </nav>
    <div style="margin-top: 20px;" class="mainsection" id="top3">
        <div class="row hide-on-small-and-down"><!--Top 3, large-->
            <div class="col s4 c_main">
                <div class="btn blue lighten-1 white-text waves-ripple waves-effect col s12 c_full z-depth-2 hoverable zoom"
                    onclick="GoTo('https://bdfz.seiue.com')">
                    <img class="img" src="./img/seiue.png" height="100px" width="auto">
                    <p class="large-plate hide-on-small-and-down">希悦</p>
                </div>
            </div>
            <div class="col s4 c_main">
                <div class="btn grey darken-3 white-text waves-ripple waves-effect col s12 c_clock z-depth-2 hoverable zoom"
                    onclick="window.open('clock.html','_self')">
            ...
            <div class="col s4  c_main">
                <div class="btn deep-orange darken-1 white-text waves-ripple waves-effect col s12 c_full z-depth-2 office hoverable zoom"
                    onclick="GoTo('https://portal.office.com')">
        ...
        <div class="row hide-on-med-and-up mobile-view"> <!--Top 3, Mobile-->
            <div class="col s12 c_main_m">
                <div class="btn blue lighten-1 white-text waves-ripple waves-effect col s12 c_full_minus z-depth-2"
                    onclick="GoTo('https://bdfz.seiue.com')">
            ...
            <div class="col s12  c_main_m">
                <div class="btn red darken-4 white-text waves-ripple waves-effect col s12 c_full_minus z-depth-2"
                    onclick="GoTo('http://www.pkuschool.edu.cn')">
            ...
            <div class="col s12  c_main_m">
                <div class="btn deep-orange darken-1 white-text waves-ripple waves-effect col s12 c_full_minus z-depth-2 office"
                    onclick="GoTo('https://portal.office.com')">
            ...
            <div class="col s12  c_main">
                    <div class="btn yue darken-1 white-text waves-ripple waves-effect col s12 c_full c_full_minus z-depth-2"
                        onclick="GoTo('http://sj2020.bdfz.seiue.com/')">
